...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder newBuilder() {
    return new com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder newBuilder(com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder();
    } else {
      return new com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder newBuilder(com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent other) {
    if (other == null) {
      return new com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder();
    } else {
      return new com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.DivyanshuLearn.microservices.order.event.OrderPlacedEvent.Builder clearEmail() {
      email = null;
